...
!(function (a, b) {
          ...
          (a = g[d]), (c = e[d]), g !== c &&
            (j && c && (m.isPlainObject (c) || (b = m.isArray (c)))
              ? (b
                  ...
                  : (f = a && m.isPlainObject (a) ? a : {}), (g[d] = m.extend (
                  j,
                  f,
                  c
                )))
  ...
  var s = (function (a) {
    ...
    function ga (a, b, d, e) {
      ...
      if (
        ((b ? b.ownerDocument || b : v) !== n && m (b), (b =
          b || n), (d = d || []), (k = b.nodeType), 'string' != typeof a ||
          !a ||
          (1 !== k && 9 !== k && 11 !== k))
      )
        return d;
    ...
    (qa.prototype = d.filters =
      d.pseudos), (d.setFilters = new qa ()), (g = ga.tokenize = function (
      a,
      b
    ) {
  ...
  var x,
    ...
    A = (m.fn.init = function (a, b) {
      ...
      if ('string' == typeof a) {
        ...
        if (c[1]) {
          if (
            ((b = b instanceof m ? b[0] : b), m.merge (
              this,
  ...
  (m.event = {
        ...
        while (h--)
          (f = _.exec (b[h]) || []), (o = q = f[1]), (p = (f[2] || '')
            ...
            ((j = m.event.special[o] || {}), (o =
              (e ? j.delegateType : j.bindType) || o), (j = m.event.special[
              o
            ] || {}), (l = m.extend (
              {
                type: o,
          ...
          if (
            ...
            while (f--)
              (g = n[f]), (!e && q !== g.origType) ||
                ...
                (n.splice (f, 1), g.selector && n.delegateCount--, l.remove &&
                  l.remove.call (a, g));
            i &&
              !n.length &&
    ...
    trigger: function (b, c, d, e) {
      ...
      if (
        ((h = l = d = d || y), 3 !== d.nodeType &&
          8 !== d.nodeType &&
          !$.test (p + m.event.triggered) &&
          (p.indexOf ('.') >= 0 &&
            ((q = p.split ('.')), (p = q.shift ()), q.sort ()), (g =
            p.indexOf (':') < 0 && 'on' + p), (b = b[m.expando]
            ? b
            ...
            (b.target = d), (c = null == c ? [b] : m.makeArray (c, [b])), (k = m
            .event.special[p] || {}), e ||
            !k.trigger ||
        ...
        while ((h = o[n++]) && !b.isPropagationStopped ())
          (b.type = n > 1 ? i : k.bindType || p), (f =
            ...
            f.apply &&
            m.acceptData (h) &&
            ((b.result = f.apply (h, c)), b.result === !1 &&
              b.preventDefault ());
        if (
          ((b.type = p), !e &&
        ...
        while ((f = h[b++]) && !a.isPropagationStopped ()) {
          ...
          while ((e = f.handlers[g++]) && !a.isImmediatePropagationStopped ())
            (!a.namespace_re || a.namespace_re.test (e.namespace)) &&
              ((a.handleObj = e), (a.data = e.data), (c = ((m.event.special[
                e.origType
              ] || {}).handle || e.handler)
    ...
    mouseHooks: {
      ...
      filter: function (a, b) {
        ...
        return null == a.pageX &&
          null != b.clientX &&
          ((d = a.target.ownerDocument || y), (e = d.documentElement), (c =
            d.body), (a.pageX =
            b.clientX +
  ...
  m.extend ({
    ...
    buildFragment: function (a, b, c, d) {
      ...
      while ((f = p[q++]))
        if (
          (!d || -1 === m.inArray (f, d)) &&
          ((g = m.contains (f.ownerDocument, f)), (h = ua (
            o.appendChild (f),
            'script'
          )), g && za (h), c)
        ) {
    ...
    return c ||
      ((c = Ea (a, b)), ('none' !== c && c) ||
        ((Ca = (Ca || m ("<iframe frameborder='0' width='0' height='0'/>"))
          ...
          Ca[0].contentDocument).document), b.write (), b.close (), (c = Ea (
          a,
          b
        )), Ca.detach ()), (Da[a] = c)), c;
  }
      ...
      return (c = y.getElementsByTagName ('body')[0]), c && c.style
        ? ((b = y.createElement ('div')), (d = y.createElement (
            ...
            ((b.style.cssText =
              ...
              '5px'), (a = 3 !== b.offsetWidth)), c.removeChild (d), a)
        : void 0;
    };
  }) ();
  var Ga = /^margin/,
      ...
      function i () {
        ...
        (c = y.getElementsByTagName ('body')[0]), c &&
          ...
          ((b = y.createElement ('div')), (d = y.createElement (
            ...
            '-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute'), (e = f = !1), (h = !0), a.getComputedStyle &&
            ((e = '1%' !== (a.getComputedStyle (b, null) || {}).top), (f =
              ...
              '-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0'), (i.style.marginRight = i.style.width =
              '0'), (b.style.width = '1px'), (h = !parseFloat (
              (a.getComputedStyle (i, null) || {}).marginRight
            )), b.removeChild (i)), (b.innerHTML =
            '<table><tr><td></td><td>t</td></tr></table>'), (i = b.getElementsByTagName (
            'td'
          )), (i[0].style.cssText =
            'margin:0;border:0;padding:0;display:none'), (g =
            0 === i[0].offsetHeight), g &&
            ((i[0].style.display = ''), (i[1].style.display = 'none'), (g =
              0 === i[0].offsetHeight)), c.removeChild (d));
      }
    }
  ...
  function Ya (a, b, c) {
    ...
    if (0 >= e || null == e) {
      if (
        ((e = Ja (a, b, f)), (0 > e || null == e) && (e = a.style[b]), Ha.test (
          e
        ))
      )
        return e;
  ...
  m.extend ({
    ...
    style: function (a, b, c, d) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        ...
        if (
          ((b = m.cssProps[h] || (m.cssProps[h] = Ua (i, h))), (g =
        ...
        if (
          ((f = typeof c), 'string' === f &&
            (e = Qa.exec (c)) &&
            ((c = (e[1] + 1) * e[2] + parseFloat (m.css (a, b))), (f =
              'number')), null != c &&
            c === c &&
            ('number' !== f ||
              m.cssNumber[h] ||
  ...
  function ib (a, b, c) {
    ...
    c.queue ||
      ...
      ((c.overflow = [p.overflow, p.overflowX, p.overflowY]), (j = m.css (
        a,
        'display'
      )), (l = 'none' === j
  ...
  function jb (a, b) {
    var c, d, e, f, g;
    for (c in a) if (
        ((d = m.camelCase (c)), (e = b[d]), (f = a[c]), m.isArray (f) &&
          ((e = f[1]), (f = a[c] = f[0])), c !== d &&
          ...
          return (d = m.isFunction (a)), this.each (function (c) {
            ...
            1 === this.nodeType &&
              ((e = d ? a.call (this, c, m (this).val ()) : a), null == e
                ...
                m.valHooks[this.nodeName.toLowerCase ()]), (b &&
                'set' in b &&
  ...
  m.extend ({
    ...
    ajax: function (a, b) {
      ...
      if (
        ((o.promise (v).complete = p.add), (v.success = v.done), (v.error =
          v.fail), (k.url = ((a || k.url || zb) + '')
          .replace (Ab, '')
          .replace (Fb, yb[1] + '//')), (k.type =
          b.method || b.type || k.method || k.type), (k.dataTypes = m
          .trim (k.dataType || '*')
          .toLowerCase ()
          ...
          ((c = Gb.exec (k.url.toLowerCase ())), (k.crossDomain = !(!c ||
            (c[1] === yb[1] &&
              c[2] === yb[2] &&
              (c[3] || ('http:' === c[1] ? '80' : '443')) ===
                (yb[3] || ('http:' === yb[1] ? '80' : '443')))))), k.data &&
          k.processData &&
          'string' != typeof k.data &&
          (k.data = m.param (k.data, k.traditional)), Mb (Hb, k, b, v), 2 === t)
      )
        return v;
      (h = m.event && k.global), h &&
        ...
        (m.lastModified[e] &&
          v.setRequestHeader ('If-Modified-Since', m.lastModified[e]), m.etag[
          e
      ...
      function x (a, b, c, d) {
        var j, r, s, u, w, x = b;
        2 !== t &&
          ((t = 2), g && clearTimeout (g), (i = void 0), (f =
            d || ''), (v.readyState = a > 0 ? 4 : 0), (j =
            (a >= 200 && 300 > a) || 304 === a), c &&
            (u = Ob (k, v, c)), (u = Pb (k, u, v, j)), j
            ? (k.ifModified &&
                ((w = v.getResponseHeader ('Last-Modified')), w &&
                  (m.lastModified[e] = w), (w = v.getResponseHeader (
                  'etag'
                )), w && (m.etag[e] = w)), 204 === a || 'HEAD' === k.type
                ? (x = 'nocontent')
                : 304 === a
                    ? (x = 'notmodified')
            ...
            (n.trigger ('ajaxComplete', [v, k]), --m.active ||
  ...
  (m.param = function (a, b) {
    ...
    if (
      (void 0 === b &&
        (b = m.ajaxSettings && m.ajaxSettings.traditional), m.isArray (a) ||
        (a.jquery && !m.isPlainObject (a)))
    )
      m.each (a, function () {
          ...
          send: function (c, d) {
            ...
            f.send ((a.hasContent && a.data) || null), (b = function (c, e) {
              ...
              if (b && (e || 4 === f.readyState))
                if (
                  (delete Xb[g], (b = void 0), (f.onreadystatechange =
                    m.noop), e)
                )
  ...
  (m.fn.load = function (a, b, c) {
    ...
    return h >= 0 &&
      ((d = m.trim (a.slice (h, a.length))), (a = a.slice (
        0,
        h
      ))), m.isFunction (b)
      ? ((c = b), (b = void 0))
    ...
    position: function () {
      if (this[0]) {
        ...
        return 'fixed' === m.css (d, 'position')
          ...
          : ((a = this.offsetParent ()), (b = this.offset ()), m.nodeName (
              a[0],
              'html'
            ) || (c = a.offset ()), (c.top += m.css (
              a[0],
              'borderTopWidth',
              !0
